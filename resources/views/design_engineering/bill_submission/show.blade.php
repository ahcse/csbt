...
@section('content')
    <div id="content" class="content">
        <ol class="breadcrumb float-xl-right">
            ...
            <li class="breadcrumb-item">Fabrication Drawing</li>
    ...
    @include('design_engineering.fabrication_drawing.delete');
    @include('design_engineering.fabrication_drawing.edit');
