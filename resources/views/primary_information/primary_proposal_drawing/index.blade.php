...
@section('content')
    <div id="content" class="content">
        <ol class="breadcrumb float-xl-right">
            ...
            <li class="breadcrumb-item active">Primary Proposal Drawing</li>
        </ol>
        <h1 class="page-header">Primary Proposal Drawing</h1>
        <div class="row">
            <div class="col-xl-12">
                <div class="panel panel-inverse">
                    <div class="panel-heading">
                        <h4 class="panel-title">Primary Proposal Drawing List</h4>
    ...
    $(document).ready(function() {
        ...
        let table = $("#data-table-list").DataTable( {
            ...
            "columns": [
                ...
                {
                  "render": function(data, type, full, meta) {
                    let btn1 = `<a href='/primary-proposal-drawings/show/${full.id}' class='btn btn-success btn-xs' data-id='${full.id}'><i class='fa fa-pencil-alt'></i></a> `;
                      return btn1;
                  }, 
                  sortable: false, searchable: false
                },
