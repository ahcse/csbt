...
@section('content')
    <div id="content" class="content">
        ...
        <h1 class="page-header">Vehicle Management <small><a href="#form" data-toggle="modal"
            ...
            <div class="col-xl-12">
                <div class="panel panel-inverse">
                    <div class="panel-heading">
                        <h4 class="panel-title">Vehicle Management</h4>
                    ...
                    <div class="panel-body">
                        <table class="table table-striped table-bordered table-td-valign-middle data-table-responsive">
                            ...
                            <tr>
                                ...
                                <td>Ongoing</td>
                                <td>
                                    <a href="/employee-salary/show" class="label label-inverse"><i class="fa fa-folder-open"></i></a>
                                </td>
                            </tr>
                            </tbody>
                        </table>
