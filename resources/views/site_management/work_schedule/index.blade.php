...
@section('content')
    <div id="content" class="content">
        ...
        <h1 class="page-header">Work Schedule</h1>
        <div class="row">
            <div class="col-xl-12">
                <div class="panel panel-inverse">
                    <div class="panel-heading">
                        <h4 class="panel-title">Work Schedule List</h4>
                    ...
                    <div class="panel-body">
                        <table class="table table-striped table-bordered table-td-valign-middle data-table-responsive">
                            ...
                            <tr>
                                ...
                                <td>Ongoing</td>
                                <td>
                                    <a href="/work-schedule/show" class="label label-inverse"><i class="fa fa-folder-open"></i></a>
                                </td>
                            </tr>
                            <tr>
                                <td>2</td>
