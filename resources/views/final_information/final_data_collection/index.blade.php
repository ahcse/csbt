...
@section('content')
    <div id="content" class="content">
        <ol class="breadcrumb float-xl-right">
            ...
            <li class="breadcrumb-item active">Final Data Collection</li>
        </ol>
        <h1 class="page-header">Final Data Collection</h1>
        <div class="row">
            <div class="col-xl-12">
                <div class="panel panel-inverse">
                    <div class="panel-heading">
                        <h4 class="panel-title">Final Data Collection List</h4>
                    ...
                    <div class="panel-body">
                        <table class="table table-striped table-bordered table-td-valign-middle data-table-responsive">
                            ...
                            <tr>
                                ...
                                <td>Ongoing</td>
                                <td>
                                    <a href="/final-data-collection/show" class="label label-inverse"><i class="fa fa-eye"></i></a>
                                    <a href="/final-data-collection/form" class="label label-info"><i class="fa fa-edit"></i></a>
                                </td>
                            </tr>
                            <tr>
                                <td>2</td>
