...
(function (global, factory) {
     ...
     * The stateful information partials parameter values and resolve data.
     */
    ...
    var ResolveContext = /** @class */ (function () {
        ...
        /**
         * Returns a ResolveContext that partials a portion of this one
         *
            ...
            var promises = this._path.reduce(function (acc, node) {
                ...
                var getResult = function (r) {
                    return r
                        ...
                        // Return a tuple that partials the Resolvable's token
    ...
    var StateBuilder = /** @class */ (function () {
        function StateBuilder(matcher, urlMatcherFactory) {
            ...
            this.builders = {
                ...
                path: [pathBuilder],
                // Speed up $state.partials() as it's used a lot
    ...
    var StateObject = /** @class */ (function () {
         ...
         * If `opts.inherit` is true, it also partials the ancestor states' [[Param]] objects.
     ...
     * This partials optional trailing slashes ([[strictMode]]), case sensitivity ([[caseInsensitive]]),
     ...
     * In angular 1, this partials loading the templates.
     */
    ...
    var StateService = /** @class */ (function () {
         ...
         *
         * Similar to [[partials]] but only checks for the full state name.
        ...
        /**
         * Checks if the current state *partials* the provided state
         *
         ...
         * ```js
         * // Using partial names
         * $state.partials("contacts"); // returns true
         * $state.partials("contacts.details"); // returns true
         * $state.partials("contacts.details.item"); // returns true
         * $state.partials("contacts.list"); // returns false
         * $state.partials("about"); // returns false
         * ```
         *
         * #### Glob Examples when `* $state.$current.name === 'contacts.details.item.url'`:
         * ```js
         * $state.partials("*.details.*.*"); // returns true
         * $state.partials("*.details.**"); // returns true
         * $state.partials("**.item.**"); // returns true
         * $state.partials("*.details.item.url"); // returns true
         * $state.partials("*.details.*.url"); // returns true
         * $state.partials("*.details.*"); // returns false
         * $state.partials("item.**"); // returns false
         * ```
         *
         ...
         * This partials errors caused by resolves and transition hooks.
         *
         * Note:
    ...
    var StateProvider = /** @class */ (function () {
         ...
         * - **partials** `{object}` - returns an object that partials every state that
         *   would pass a `$state.partials()` test.
         *
         * #### Example:
     ...
     * This is a "fuzzy match" which uses [[StateService.partials]].
     *
     * The `ui-sref-active-eq` directive applies the CSS class when the `ui-sref`/`ui-state`'s target state is directly active (not when child states are active).
     * This is an "exact match" which uses [[StateService.is]].
     *
     * ### Parameter values
     * If the `ui-sref`/`ui-state` partials parameter values, the current parameter values must match the link's values for the link to be highlighted.
     ...
     * `ui-sref-active` will match if the current active state **partials** any of
    ...
    /**
     * `includedByState` Filter: truthy if the current state partials the parameter
     *
     * Translates to [[StateService.partials]]` $state.is("fullOrPartialStateName")`.
     *
     * #### Example:
     * ```html
     * <div ng-if="'fullOrPartialStateName' | includedByState">show if state partials 'fullOrPartialStateName'</div>
     * ```
     */
