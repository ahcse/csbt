...
@section('content')
    <div id="content" class="content">
        ...
        <h1 class="page-header">Bill Submission</h1>
        <div class="row">
            <div class="col-xl-12">
                <div class="panel panel-inverse">
                    <div class="panel-heading">
                        <h4 class="panel-title">Bill Submission</h4>
                    ...
                    <div class="panel-body">
                        <table class="table table-striped table-bordered table-td-valign-middle data-table-responsive">
                            ...
                            <tr>
                                ...
                                <th class="text-nowrap">Value(Tk.)</th>
                                <th class="text-nowrap">Area(Ton)</th>
                            ...
                            <tr>
                                ...
                                <td>Ongoing</td>
                                <td>
                                    <a href="#" class="label label-inverse"><i class="fa fa-eye"></i></a>
                                </td>
                            </tr>
                            <tr>
                                <td>2</td>
    ...
    @include('partials.project_filter');
@endsection
