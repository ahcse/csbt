...
@section('content')
    <div id="content" class="content">
        <ol class="breadcrumb float-xl-right">
            ...
            <li class="breadcrumb-item active">Final Estimation</li>
        </ol>
        <h1 class="page-header">Final Estimation</h1>
        <div class="row">
            <div class="col-xl-12">
                <div class="panel panel-inverse">
                    <div class="panel-heading">
                        <h4 class="panel-title">Final Estimation List</h4>
                    ...
                    <div class="panel-body">
                        <table class="table table-striped table-bordered table-td-valign-middle data-table-responsive">
                            ...
                            <tr>
                                ...
                                <td>Ongoing</td>
                                <td>
                                    <a href="/final-estimation/show" class="label label-inverse"><i class="fa fa-folder-open"></i></a>
                                </td>
                            </tr>
                            <tr>
                                <td>2</td>
